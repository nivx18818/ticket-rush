...
export enum ErrorCode {
  ...
  SEAT_NOT_AVAILABLE = 40905,
  ORDER_NOT_PENDING = 40906,
  ORDER_EXPIRED = 40907,
  ORDER_SEATS_INVALID = 40908,
...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  [ErrorCode.SEAT_NOT_AVAILABLE]: 'Seat is no longer available',
  [ErrorCode.ORDER_NOT_PENDING]: 'Order is not pending',
  [ErrorCode.ORDER_EXPIRED]: 'Order has expired',
  [ErrorCode.ORDER_SEATS_INVALID]: 'Order seats are invalid',
  // 429 - Too Many Requests
